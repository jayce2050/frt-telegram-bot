...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1745595500);
user_pref("app.update.lastUpdateTime.background-update-timer", 1745595500);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1745595500);
user_pref("app.update.lastUpdateTime.region-update-timer", 1745595500);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1745595500);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1745595500);
...
user_pref("browser.contextual-services.contextId", "{3b6240fd-adf6-4063-bd55-176da7fce95f}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{f7951005-750e-4083-bdd4-61a671fdbe09}");
...
user_pref("browser.startup.lastColdStartupCheck", 1745595471);
...
user_pref("captchadetection.lastSubmission", 1745595);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECLyCP+c5MU70BAiTcrGoTmASTA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"114d19f6-76b1-44d7-bf30-bddf161326f9\",\"pictureinpicture@mozilla.org\":\"a0007e00-6636-4d19-bb54-b906f1363e24\",\"screenshots@mozilla.org\":\"d9416dfe-e61b-4910-ad4e-14c2de309e86\",\"webcompat-reporter@mozilla.org\":\"878ea4a7-159e-4a47-ba21-07f1157692a6\",\"webcompat@mozilla.org\":\"97634224-fff9-45b0-976d-a92fad7772c7\",\"default-theme@mozilla.org\":\"3d54f491-3504-4855-8d17-8a9b8cdcb2af\",\"addons-search-detection@mozilla.com\":\"4e2e9838-89c3-45bd-b927-4a34fe2afe27\"}");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBDWHc52GP1lBAhoc3HSoDIXHg==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1745595469);
